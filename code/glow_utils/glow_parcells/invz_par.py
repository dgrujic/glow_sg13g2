...
invz_par = Symsubcircuit("invz_par", ['A', 'EN', 'ENB', 'Y', 'VDD', 'VSS'], {'WN' : 300e-9, 'WP' : 450e-9, 'L' : 130e-9, 'NGN' : 1, 'NGP' : 1, 'WEAK' : 0})
n0 = SymNMOS("N0", ['Y', 'EN', 'net0', 'VSS'], {'w' : 'ppar("WN")', 'l' : 'ppar("L")', 'ng' : 'ppar("NGN")', 'weak' : 'ppar("WEAK")'})
n1 = SymNMOS("N1", ['net0', 'A', 'VSS', 'VSS'], {'w' : 'ppar("WN")', 'l' : 'ppar("L")', 'ng' : 'ppar("NGN")', 'weak' : 'ppar("WEAK")'})
p0 = SymPMOS("P0", ['Y', 'ENB', 'net1', 'VDD'], {'w' : 'ppar("WP")', 'l' : 'ppar("L")', 'ng' : 'ppar("NGP")', 'weak' : 'ppar("WEAK")'})
p1 = SymPMOS("P1", ['net1', 'A', 'VDD', 'VDD'], {'w' : 'ppar("WP")', 'l' : 'ppar("L")', 'ng' : 'ppar("NGP")', 'weak' : 'ppar("WEAK")'})
invz_par.addElement([n0, n1, p0, p1])
