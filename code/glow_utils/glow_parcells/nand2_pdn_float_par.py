...
# Parametrized floating NAND2 pull-down network subcircuit
# Terminals:
#   A       input
#   B       input
#   Y       output
...
nand2_pdn_float_par = Symsubcircuit("nand2_pdn_float_par", ['A', 'B', 'Y', 'X', 'VSS'], {'WN' : 300e-9, 'L' : 130e-9, 'NGN' : 1})
n0 = SymNMOS("N0", ['n0', 'B', 'X', 'VSS'], {'w' : 'ppar("WN")', 'l' : 'ppar("L")', 'ng' : 'ppar("NGN")'})
n1 = SymNMOS("N1", ['Y', 'A', 'n0', 'VSS'], {'w' : 'ppar("WN")', 'l' : 'ppar("L")', 'ng' : 'ppar("NGN")'})
nand2_pdn_float_par.addElement([n0, n1])
