...
def printusage():
    print("*"*80)
    print("")
    print("batch_checkcell runs the check_cell on a batch of cells ")
    print("")
    print("Usage :")
    print("batch_checkcell -i file1 -i file2 ...")
    print("")
    print("Input files contain list of cells to run in check_cell.")
    ...
    print("INV_D4")
    print("----------------------")
    print("This file runs check_cell on cells INV_D1, INV_D2 and INV_D4")
    print("*"*80)
...
def main():
    ...
    if not quiet:
        print("*"*80)
        print("Running batch check_cell on cells :")
    ...
    for cell in cells:
        cell_dir = "./" + cell
        cmd = "$GLOW_ROOT/code/scripts/check_cell.sh " + cell + ".gds " + cell
        try:
