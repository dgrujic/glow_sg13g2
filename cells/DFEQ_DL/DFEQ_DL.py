...
def info():
    ...
    """
    cellInfo = { 'name' : 'DFEQ_DL',
                 'pinList' : ['D', 'E', 'CLK', 'Q', 'VDD', 'VSS'],
                 'description' : 'D flip-flop with enable and Q output with weak drive strength'
    }
    return cellInfo
...
def generate(genFlat = True, anonimize = True):
    ...
    DFEQ_DL = Symsubcircuit(cellInfo['name'], ['D', 'E', 'CLK', 'Q', 'VDD', 'VSS'])
    # Clock inverters
    ...
    DFEQ_DL.addElement([inv_clkn, inv_clki, inv_enb,
                          n0, n1, n2, n3, n4,
                          p0, p1, p2, p3, p4,
                          inv_ml, invz_mfb, 
                          invz_ms, 
    ...
    # Flatten the circuit
    if genFlat:
        DFEQ_DL_flat = DFEQ_DL.flat()
    if anonimize:
        DFEQ_DL_flat.anonimize()
