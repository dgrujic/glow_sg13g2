...
def info():
    ...
    """
    cellInfo = { 'name' : 'DFEQ_D1',
                 'pinList' : ['D', 'E', 'CLK', 'Q', 'VDD', 'VSS'],
                 'description' : 'D flip-flop with enable and Q output with drive strength x1'
    }
    return cellInfo
...
def generate(genFlat = True, anonimize = True):
    ...
    DFEQ_D1 = Symsubcircuit(cellInfo['name'], ['D', 'E', 'CLK', 'Q', 'VDD', 'VSS'])
    # Clock inverters
    ...
    DFEQ_D1.addElement([inv_clkn, inv_clki, inv_enb,
                          n0, n1, n2, n3, n4,
                          p0, p1, p2, p3, p4,
                          inv_ml, invz_mfb, 
                          invz_ms, 
    ...
    # Flatten the circuit
    if genFlat:
        DFEQ_D1_flat = DFEQ_D1.flat()
    if anonimize:
        DFEQ_D1_flat.anonimize()
