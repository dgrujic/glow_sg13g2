...
def info():
    ...
    """
    cellInfo = { 'name' : 'OAI222_DL',
                 'pinList' : ['A', 'B', 'C', 'D', 'E', 'F', 'Y', 'VDD', 'VSS'],
                 'description' : 'OAI222 with weak drive strength'
    }
    return cellInfo
...
def generate(genFlat = True, anonimize = True):
    ...
    OAI222_DL = Symsubcircuit(cellInfo['name'], cellInfo['pinList'])
    ...
    OAI222_DL.addElement([n0, n1, n2, n3, n4, n5, p0, p1, p2, p3, p4, p5])

    # Flatten the circuit
    if genFlat:
        OAI222_DL_flat = OAI222_DL.flat()
    if anonimize:
        OAI222_DL_flat.anonimize()
