...
def info():
    ...
    """
    cellInfo = { 'name' : 'DFESQ_D1',
                 'pinList' : ['D', 'E', 'S', 'CLK', 'Q', 'VDD', 'VSS'],
                 'description' : 'D flip-flop with enable, set S, and Q output with drive strength x1'
    }
    return cellInfo
...
def generate(genFlat = True, anonimize = True):
    ...
    DFESQ_D1 = Symsubcircuit(cellInfo['name'], ['D', 'E', 'S', 'CLK', 'Q', 'VDD', 'VSS'])
    # Clock inverters
    ...
    DFESQ_D1.addElement([inv_clkn, inv_clki, inv_enb,
                          ns, n0, n1, n2, n3, n4,
                          ps, p0, p1, p2, p3, p4,
                          inv_ml, invz_mfb, 
                          invz_ms, 
    ...
    # Flatten the circuit
    if genFlat:
        DFESQ_D1_flat = DFESQ_D1.flat()
    if anonimize:
        DFESQ_D1_flat.anonimize()
