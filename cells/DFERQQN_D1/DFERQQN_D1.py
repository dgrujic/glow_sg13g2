...
def info():
    ...
    """
    cellInfo = { 'name' : 'DFERQQN_D1',
                 'pinList' : ['D', 'E', 'RN', 'CLK', 'Q', 'QN', 'VDD', 'VSS'],
                 'description' : 'D flip-flop with enable, reset and Q and QN outputs with drive strength x1'
    }
    return cellInfo
...
def generate(genFlat = True, anonimize = True):
    ...
    DFERQQN_D1 = Symsubcircuit(cellInfo['name'], ['D', 'E', 'RN', 'CLK', 'Q', 'QN', 'VDD', 'VSS'])
    # Clock inverters
    ...
    DFERQQN_D1.addElement([inv_clkn, inv_clki, inv_enb,
                          ns, n0, n1, n2, n3, n4,
                          ps, p0, p1, p2, p3, p4,
                          inv_ml, invz_mfb, 
                          invz_ms, 
    ...
    # Flatten the circuit
    if genFlat:
        DFERQQN_D1_flat = DFERQQN_D1.flat()
    if anonimize:
        DFERQQN_D1_flat.anonimize()
