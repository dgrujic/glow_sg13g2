...
def info():
    ...
    """
    cellInfo = { 'name' : 'NAND4N2_D2',
                 'pinList' : ['AN', 'BN', 'C', 'D', 'Y', 'VDD', 'VSS'],
                 'description' : 'NAND4 with inverted inputs A, B and drive strength x2'
    }
    return cellInfo
...
def generate(genFlat = True, anonimize = True):
    ...
    NAND4N2_D2 = Symsubcircuit(cellInfo['name'], cellInfo['pinList'])
    nand_name = "NAND4_D2"
    ...
    NAND4N2_D2.addElement([nand4_inst, invA_inst, invB_inst])

    # Flatten the circuit
    if genFlat:
        NAND4N2_D2_flat = NAND4N2_D2.flat()
    if anonimize:
        NAND4N2_D2_flat.anonimize()
