...
def generate(genFlat = True, anonimize = True):
    ...
    NAND2_D4 = Symsubcircuit(cellInfo['name'], cellInfo['pinList'])
    ...
    NAND2_D4.addElement([nand2_pdn1, nand2_pdn2, nand2_pdn3, nand2_pun1, nand2_pun2])

    # Flatten the circuit
    if genFlat:
        NAND2_D4_flat = NAND2_D4.flat()
    if anonimize:
        NAND2_D4_flat.anonimize()
