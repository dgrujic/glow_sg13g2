...
def info():
    ...
    """
    cellInfo = { 'name' : 'NAND4N2_D1',
                 'pinList' : ['AN', 'BN', 'C', 'D', 'Y', 'VDD', 'VSS'],
                 'description' : 'NAND4 with inverted inputs A, B and drive strength x1'
    }
    return cellInfo
...
def generate(genFlat = True, anonimize = True):
    ...
    NAND4N2_D1.addElement([nand4_inst, invA_inst, invB_inst])

    # Flatten the circuit
    if genFlat:
        NAND4N2_D1_flat = NAND4N2_D1.flat()
    if anonimize:
        NAND4N2_D1_flat.anonimize()
