...
def info():
    ...
    """
    cellInfo = { 'name' : 'DFERQN_D2',
                 'pinList' : ['D', 'E', 'RN', 'CLK', 'QN', 'VDD', 'VSS'],
                 'description' : 'D flip-flop with enable, reset and QN output with drive strength x2'
    }
    return cellInfo
...
def generate(genFlat = True, anonimize = True):
    ...
    DFERQN_D2 = Symsubcircuit(cellInfo['name'], ['D', 'E', 'RN', 'CLK', 'QN', 'VDD', 'VSS'])
    # Clock inverters
    ...
    DFERQN_D2.addElement([inv_clkn, inv_clki, inv_enb,
                          ns, n0, n1, n2, n3, n4,
                          ps, p0, p1, p2, p3, p4,
                          inv_ml, invz_mfb, 
                          invz1_ms, invz2_ms,
    ...
    # Flatten the circuit
    if genFlat:
        DFERQN_D2_flat = DFERQN_D2.flat()
    if anonimize:
        DFERQN_D2_flat.anonimize()
