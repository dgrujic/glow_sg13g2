...
def info():
    ...
    """
    cellInfo = { 'name' : 'DFESQQN_DL',
                 'pinList' : ['D', 'E', 'S', 'CLK', 'Q', 'QN', 'VDD', 'VSS'],
                 'description' : 'D flip-flop with enable, set S, and Q and QN outputs with weak drive strength'
    }
    return cellInfo
...
def generate(genFlat = True, anonimize = True):
    ...
    DFESQQN_DL = Symsubcircuit(cellInfo['name'], ['D', 'E', 'S', 'CLK', 'Q', 'QN', 'VDD', 'VSS'])
    # Clock inverters
    ...
    DFESQQN_DL.addElement([inv_clkn, inv_clki, inv_enb,
                          ns, n0, n1, n2, n3, n4,
                          ps, p0, p1, p2, p3, p4,
                          inv_ml, invz_mfb, 
                          invz_ms, 
    ...
    # Flatten the circuit
    if genFlat:
        DFESQQN_DL_flat = DFESQQN_DL.flat()
    if anonimize:
        DFESQQN_DL_flat.anonimize()
