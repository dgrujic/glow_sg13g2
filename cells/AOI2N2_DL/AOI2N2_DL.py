...
def info():
    ...
    """
    cellInfo = { 'name' : 'AOI2N2_DL',
                 'pinList' : ['A', 'B', 'C', 'D', 'Y', 'VDD', 'VSS'],
                 'description' : 'AOI2N2 with weak drive strength'
    }
    return cellInfo
...
def generate(genFlat = True, anonimize = True):
    ...
    AOI2N2_DL = Symsubcircuit(cellInfo['name'], cellInfo['pinList'])
    ...
    AOI2N2_DL.addElement([n0, n1, n2, n3, n4, p0, p1, p2, p3, p4])

    # Flatten the circuit
    if genFlat:
        AOI2N2_DL_flat = AOI2N2_DL.flat()
    if anonimize:
        AOI2N2_DL_flat.anonimize()
