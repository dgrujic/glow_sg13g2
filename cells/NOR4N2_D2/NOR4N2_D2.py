...
def info():
    ...
    """
    cellInfo = { 'name' : 'NOR4N2_D2',
                 'pinList' : ['AN', 'BN', 'C', 'D', 'Y', 'VDD', 'VSS'],
                 'description' : 'NOR4 with inverted inputs A, B and drive strength x2'
    }
    return cellInfo
...
def generate(genFlat = True, anonimize = True):
    ...
    NOR4N2_D2 = Symsubcircuit(cellInfo['name'], cellInfo['pinList'])
    ...
    NOR4N2_D2.addElement([inv_inst1, inv_inst2, nor4])

    # Flatten the circuit
    if genFlat:
        NOR4N2_D2_flat = NOR4N2_D2.flat()
    if anonimize:
        NOR4N2_D2_flat.anonimize()
