...
def info():
    ...
    """
    cellInfo = { 'name' : 'OA22_D1',
                 'pinList' : ['A', 'B', 'C', 'D', 'Y', 'VDD', 'VSS'],
                 'description' : 'OA22 with drive strength x1'
    }
    return cellInfo
...
def generate(genFlat = True, anonimize = True):
    ...
    OA22_D1 = Symsubcircuit(cellInfo['name'], cellInfo['pinList'])
    ...
    OA22_D1.addElement([n0, n1, n2, n3, p0, p1, p2, p3, inv1])

    # Flatten the circuit
    if genFlat:
        OA22_D1_flat = OA22_D1.flat()
    if anonimize:
        OA22_D1_flat.anonimize()
