...
def generate(genFlat = True, anonimize = True):
    ...
    AOI2N1_D1 = Symsubcircuit(cellInfo['name'], cellInfo['pinList'])
    ...
    AOI2N1_D1.addElement([n0, n1, n2, n3, p0, p1, p2, p3])

    # Flatten the circuit
    if genFlat:
        AOI2N1_D1_flat = AOI2N1_D1.flat()
    if anonimize:
        AOI2N1_D1_flat.anonimize()
