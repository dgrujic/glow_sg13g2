...
def info():
    ...
    """
    cellInfo = { 'name' : 'NOR2_D2',
                 'pinList' : ['A', 'B', 'Y', 'VDD', 'VSS'],
                 'description' : 'NOR2 with drive strength x2'
    }
    return cellInfo
...
def generate(genFlat = True, anonimize = True):
    ...
    NOR2_D2 = Symsubcircuit(cellInfo['name'], cellInfo['pinList'])
    ...
    nor2_pdn1 = nor2_pdn_par('nor2_pdn1', cellInfo['pinList'], {'WN' : wn})
    NOR2_D2.addElement([nor2_pdn1, nor2_pun1, nor2_pun2])
    
    # Flatten the circuit
    if genFlat:
        NOR2_D2_flat = NOR2_D2.flat()
    if anonimize:
        NOR2_D2_flat.anonimize()
