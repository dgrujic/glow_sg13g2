...
def info():
    ...
    """
    cellInfo = { 'name' : 'OAI22_DL',
                 'pinList' : ['A', 'B', 'C', 'D', 'Y', 'VDD', 'VSS'],
                 'description' : 'OAI22 with weak drive strength'
    }
    return cellInfo
...
def generate(genFlat = True, anonimize = True):
    ...
    OAI22_DL.addElement([n0, n1, n2, n3, p0, p1, p2, p3])

    # Flatten the circuit
    if genFlat:
        OAI22_DL_flat = OAI22_DL.flat()
    if anonimize:
        OAI22_DL_flat.anonimize()
