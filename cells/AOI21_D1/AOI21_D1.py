...
def info():
    ...
    """
    cellInfo = { 'name' : 'AOI21_D1',
                 'pinList' : ['A', 'B', 'C', 'Y', 'VDD', 'VSS'],
                 'description' : 'AOI21 with drive strength x1'
    }
    return cellInfo
...
def generate(genFlat = True, anonimize = True):
    ...
    AOI21_D1 = Symsubcircuit(cellInfo['name'], cellInfo['pinList'])
    wns = 900e-9
    ...
    AOI21_D1.addElement([n0, n1, n2, p0, p1, p2])

    # Flatten the circuit
    if genFlat:
        AOI21_D1_flat = AOI21_D1.flat()
    if anonimize:
        AOI21_D1_flat.anonimize()
