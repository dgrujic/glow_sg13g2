...
def info():
    ...
    """
    cellInfo = { 'name' : 'OAI2N1_DL',
                 'pinList' : ['A', 'B', 'C', 'Y', 'VDD', 'VSS'],
                 'description' : 'OAI2N1 with weak drive strength'
    }
    return cellInfo
...
def generate(genFlat = True, anonimize = True):
    ...
    OAI2N1_DL = Symsubcircuit(cellInfo['name'], cellInfo['pinList'])
    ...
    OAI2N1_DL.addElement([n0, n1, n2, n3, p0, p1, p2, p3])

    # Flatten the circuit
    if genFlat:
        OAI2N1_DL_flat = OAI2N1_DL.flat()
    if anonimize:
        OAI2N1_DL_flat.anonimize()
