...
def info():
    ...
    """
    cellInfo = { 'name' : 'AOI222_DL',
                 'pinList' : ['A', 'B', 'C', 'D', 'E', 'F', 'Y', 'VDD', 'VSS'],
                 'description' : 'AOI222 with weak drive strength'
    }
    return cellInfo
...
def generate(genFlat = True, anonimize = True):
    ...
    AOI222_DL = Symsubcircuit(cellInfo['name'], cellInfo['pinList'])
    wns = 500e-9
    wp = 2 * wns
    ...
    AOI222_DL.addElement([n0, n1, n2, n3, n4, n5, p0, p1, p2, p3, p4, p5])

    # Flatten the circuit
    if genFlat:
        AOI222_DL_flat = AOI222_DL.flat()
    if anonimize:
        AOI222_DL_flat.anonimize()
