...
def info():
    ...
    """
    cellInfo = { 'name' : 'AO22_D2',
                 'pinList' : ['A', 'B', 'C', 'D', 'Y', 'VDD', 'VSS'],
                 'description' : 'AO22 with drive strength x2'
    }
    return cellInfo
...
def generate(genFlat = True, anonimize = True):
    ...
    AO22_D2 = Symsubcircuit(cellInfo['name'], cellInfo['pinList'])
    wn = 500e-9
    wp = 600e-9
    ...
    AO22_D2.addElement([n0, n1, n2, n3, p0, p1, p2, p3, inv_inst])

    # Flatten the circuit
    if genFlat:
        AO22_D2_flat = AO22_D2.flat()
    if anonimize:
        AO22_D2_flat.anonimize()
