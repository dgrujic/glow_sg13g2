...
def info():
    ...
    """
    cellInfo = { 'name' : 'DFEQQN_D2',
                 'pinList' : ['D', 'E', 'CLK', 'Q', 'QN', 'VDD', 'VSS'],
                 'description' : 'D flip-flop with enable and Q and QN outputs with drive strength x2'
    }
    return cellInfo
...
def generate(genFlat = True, anonimize = True):
    ...
    DFEQQN_D2 = Symsubcircuit(cellInfo['name'], ['D', 'E', 'CLK', 'Q', 'QN', 'VDD', 'VSS'])
    # Clock inverters
    ...
    DFEQQN_D2.addElement([inv_clkn, inv_clki, inv_enb,
                          n0, n1, n2, n3, n4,
                          p0, p1, p2, p3, p4,
                          inv_ml, invz_mfb, 
                          invz_ms1, invz_ms2, 
    ...
    # Flatten the circuit
    if genFlat:
        DFEQQN_D2_flat = DFEQQN_D2.flat()
    if anonimize:
        DFEQQN_D2_flat.anonimize()
