...
def info():
    ...
    """
    cellInfo = { 'name' : 'AOI221_D1',
                 'pinList' : ['A', 'B', 'C', 'D', 'E', 'Y', 'VDD', 'VSS'],
                 'description' : 'AOI221 with drive strength x1'
    }
    return cellInfo
...
def generate(genFlat = True, anonimize = True):
    ...
    AOI221_D1 = Symsubcircuit(cellInfo['name'], cellInfo['pinList'])
    ...
    AOI221_D1.addElement([n0, n1, n2, n3, n4, p0, p1, p2, p3, p4])

    # Flatten the circuit
    if genFlat:
        AOI221_D1_flat = AOI221_D1.flat()
    if anonimize:
        AOI221_D1_flat.anonimize()
