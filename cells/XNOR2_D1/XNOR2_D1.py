...
def info():
    ...
    """
    cellInfo = { 'name' : 'XNOR2_D1',
                 'pinList' : ['A', 'B', 'Y', 'VDD', 'VSS'],
                 'description' : 'XNOR2 with drive strength x1'
    }
    return cellInfo
...
def generate(genFlat = True, anonimize = True):
    ...
    XNOR2_D1 = Symsubcircuit(cellInfo['name'], cellInfo['pinList'])
    ...
    # NMOS
    n0 = SymNMOS("N0", ['BN', 'AN', 'Y', 'VSS'], {'w' : wn, 'l' : lmin })
    n1 = SymNMOS("N1", ['BI', 'A', 'Y', 'VSS'], {'w' : wn, 'l' : lmin })

    # PMOS
    p0 = SymPMOS("P0", ['BN', 'A', 'Y', 'VDD'], {'w' : wp, 'l' : lmin })
    p1 = SymPMOS("P1", ['BI', 'AN', 'Y', 'VDD'], {'w' : wp, 'l' : lmin })
    ...
    XNOR2_D1.addElement([inv_inst1, inv_inst2, inv_inst3, n0, n1, p0, p1])

    # Flatten the circuit
    if genFlat:
        XNOR2_D1_flat = XNOR2_D1.flat()
    if anonimize:
        XNOR2_D1_flat.anonimize()
