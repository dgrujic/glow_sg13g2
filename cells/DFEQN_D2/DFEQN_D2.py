...
def info():
    ...
    """
    cellInfo = { 'name' : 'DFEQN_D2',
                 'pinList' : ['D', 'E', 'CLK', 'Q', 'VDD', 'VSS'],
                 'description' : 'D flip-flop with enable and QN output with drive strength x2'
    }
    return cellInfo
...
def generate(genFlat = True, anonimize = True):
    ...
    DFEQN_D2 = Symsubcircuit(cellInfo['name'], ['D', 'E', 'CLK', 'QN', 'VDD', 'VSS'])
    # Clock inverters
    ...
    DFEQN_D2.addElement([inv_clkn, inv_clki, inv_enb,
                          n0, n1, n2, n3, n4,
                          p0, p1, p2, p3, p4,
                          inv_ml, invz_mfb, 
                          invz_ms1, invz_ms2, 
    ...
    # Flatten the circuit
    if genFlat:
        DFEQN_D2_flat = DFEQN_D2.flat()
    if anonimize:
        DFEQN_D2_flat.anonimize()
