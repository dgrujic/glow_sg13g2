...
def info():
    ...
    cellInfo = { 'name' : 'DFERQQN_D1',
                 ...
                 'description' : 'D flip-flop with enable, reset and Q output with drive strength x1'
    }
    return cellInfo
...
def generate(genFlat = True, anonimize = True):
    ...
    DFERQ_D1.addElement([inv_clkn, inv_clki, inv_enb,
                          ns, n0, n1, n2, n3, n4,
                          ps, p0, p1, p2, p3, p4,
                          inv_ml, invz_mfb, 
                          invz_ms, 
    ...
    # Flatten the circuit
    if genFlat:
        DFERQ_D1_flat = DFERQ_D1.flat()
    if anonimize:
        DFERQ_D1_flat.anonimize()
