...
def info():
    ...
    """
    cellInfo = { 'name' : 'DFEQN_DL',
                 'pinList' : ['D', 'E', 'CLK', 'QN', 'VDD', 'VSS'],
                 'description' : 'D flip-flop with enable and QN output with weak drive strength'
    }
    return cellInfo
...
def generate(genFlat = True, anonimize = True):
    ...
    DFEQN_DL = Symsubcircuit(cellInfo['name'], ['D', 'E', 'CLK', 'QN', 'VDD', 'VSS'])
    # Clock inverters
    ...
    DFEQN_DL.addElement([inv_clkn, inv_clki, inv_enb,
                          n0, n1, n2, n3, n4,
                          p0, p1, p2, p3, p4,
                          inv_ml, invz_mfb, 
                          invz_ms, 
    ...
    # Flatten the circuit
    if genFlat:
        DFEQN_DL_flat = DFEQN_DL.flat()
    if anonimize:
        DFEQN_DL_flat.anonimize()
