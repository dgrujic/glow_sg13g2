...
def info():
    ...
    """
    cellInfo = { 'name' : 'DFERQN_DL',
                 'pinList' : ['D', 'E', 'RN', 'CLK', 'QN', 'VDD', 'VSS'],
                 'description' : 'D flip-flop with enable, reset and QN output with weak drive strength'
    }
    return cellInfo
...
def generate(genFlat = True, anonimize = True):
    ...
    DFERQN_DL = Symsubcircuit(cellInfo['name'], ['D', 'E', 'RN', 'CLK', 'QN', 'VDD', 'VSS'])
    # Clock inverters
    ...
    DFERQN_DL.addElement([inv_clkn, inv_clki, inv_enb,
                          ns, n0, n1, n2, n3, n4,
                          ps, p0, p1, p2, p3, p4,
                          inv_ml, invz_mfb, 
                          invz_ms, 
    ...
    # Flatten the circuit
    if genFlat:
        DFERQN_DL_flat = DFERQN_DL.flat()
    if anonimize:
        DFERQN_DL_flat.anonimize()
