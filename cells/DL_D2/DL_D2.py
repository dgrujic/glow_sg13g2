...
def info():
    ...
    cellInfo = { 'name' : 'DL_D2',
                 ...
                 'description' : 'Latch with Q and QN outputs and drive strength x2'
    }
    return cellInfo
...
def generate(genFlat = True, anonimize = True):
    ...
    invz2 = invz_par("invz2", ['D', 'g', 'gn', 'qin', 'VDD', 'VSS'], {'WN' : 1000e-9, 'WP' : 1300e-9})
    ...
    DL_D2.addElement([inv_g, inv_gn, invz1, invz2, inv_Q, inv_qi, inv_QN])

    # Flatten the circuit
    if genFlat:
        DL_D2_flat = DL_D2.flat()
    if anonimize:
        DL_D2_flat.anonimize()
