...
def info():
    ...
    """
    cellInfo = { 'name' : 'DFESQ_DL',
                 'pinList' : ['D', 'E', 'S', 'CLK', 'Q', 'VDD', 'VSS'],
                 'description' : 'D flip-flop with enable, set S, and Q output with weak drive strength'
    }
    return cellInfo
...
def generate(genFlat = True, anonimize = True):
    ...
    DFESQ_DL = Symsubcircuit(cellInfo['name'], ['D', 'E', 'S', 'CLK', 'Q', 'VDD', 'VSS'])
    # Clock inverters
    ...
    DFESQ_DL.addElement([inv_clkn, inv_clki, inv_enb,
                          ns, n0, n1, n2, n3, n4,
                          ps, p0, p1, p2, p3, p4,
                          inv_ml, invz_mfb, 
                          invz_ms, 
    ...
    # Flatten the circuit
    if genFlat:
        DFESQ_DL_flat = DFESQ_DL.flat()
    if anonimize:
        DFESQ_DL_flat.anonimize()
