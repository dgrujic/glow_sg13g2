...
def info():
    ...
    """
    cellInfo = { 'name' : 'DFESQN_DL',
                 'pinList' : ['D', 'E', 'S', 'CLK', 'QN', 'VDD', 'VSS'],
                 'description' : 'D flip-flop with enable, set S, and QN output with weak drive strength'
    }
    return cellInfo
...
def generate(genFlat = True, anonimize = True):
    ...
    DFESQN_DL = Symsubcircuit(cellInfo['name'], ['D', 'E', 'S', 'CLK', 'QN', 'VDD', 'VSS'])
    # Clock inverters
    ...
    DFESQN_DL.addElement([inv_clkn, inv_clki, inv_enb,
                          ns, n0, n1, n2, n3, n4,
                          ps, p0, p1, p2, p3, p4,
                          inv_ml, invz_mfb, 
                          invz_ms, 
    ...
    # Flatten the circuit
    if genFlat:
        DFESQN_DL_flat = DFESQN_DL.flat()
    if anonimize:
        DFESQN_DL_flat.anonimize()
