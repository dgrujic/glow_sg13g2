...
def info():
    ...
    """
    cellInfo = { 'name' : 'DFESQQN_D1',
                 'pinList' : ['D', 'E', 'S', 'CLK', 'Q', 'QN', 'VDD', 'VSS'],
                 'description' : 'D flip-flop with enable, set S, and Q and QN outputs with drive strength x1'
    }
    return cellInfo
...
def generate(genFlat = True, anonimize = True):
    ...
    DFESQQN_D1.addElement([inv_clkn, inv_clki, inv_enb,
                          ns, n0, n1, n2, n3, n4,
                          ps, p0, p1, p2, p3, p4,
                          inv_ml, invz_mfb, 
                          invz_ms, 
    ...
    # Flatten the circuit
    if genFlat:
        DFESQQN_D1_flat = DFESQQN_D1.flat()
    if anonimize:
        DFESQQN_D1_flat.anonimize()
