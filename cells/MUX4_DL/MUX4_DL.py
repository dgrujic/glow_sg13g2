...
def info():
    ...
    """
    cellInfo = { 'name' : 'MUX4_DL',
                 'pinList' : ['I0', 'I1', 'I2', 'I3', 'S0', 'S1', 'Y', 'VDD', 'VSS'],
                 'description' : 'MUX4 with weak drive strength'
    }
    return cellInfo
...
def generate(genFlat = True, anonimize = True):
    ...
    MUX4_DL = Symsubcircuit(cellInfo['name'], cellInfo['pinList'])
    inv_ctrl0_wn = 200e-9
    ...
    MUX4_DL.addElement([inv_inst_S0, inv_inst_S1, inv_inst_Y])
    MUX4_DL.addElement([invz_inst_I0, invz_inst_I1, invz_inst_I2, invz_inst_I3])
    MUX4_DL.addElement([tgate_inst1, tgate_inst2])

    # Flatten the circuit
    if genFlat:
        MUX4_DL_flat = MUX4_DL.flat()
    if anonimize:
        MUX4_DL_flat.anonimize()
