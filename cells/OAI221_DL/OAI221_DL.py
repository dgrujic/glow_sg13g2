...
def info():
    ...
    """
    cellInfo = { 'name' : 'OAI221_DL',
                 'pinList' : ['A', 'B', 'C', 'D', 'E', 'Y', 'VDD', 'VSS'],
                 'description' : 'OAI221 with weak drive strength'
    }
    return cellInfo
...
def generate(genFlat = True, anonimize = True):
    ...
    OAI221_DL = Symsubcircuit(cellInfo['name'], cellInfo['pinList'])
    ...
    OAI221_DL.addElement([n0, n1, n2, n3, n4, p0, p1, p2, p3, p4])

    # Flatten the circuit
    if genFlat:
        OAI221_DL_flat = OAI221_DL.flat()
    if anonimize:
        OAI221_DL_flat.anonimize()
