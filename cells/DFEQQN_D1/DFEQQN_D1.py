...
def info():
    ...
    """
    cellInfo = { 'name' : 'DFEQQN_D1',
                 'pinList' : ['D', 'E', 'CLK', 'Q', 'QN', 'VDD', 'VSS'],
                 'description' : 'D flip-flop with enable and Q and QN outputs with drive strength x1'
    }
    return cellInfo
...
def generate(genFlat = True, anonimize = True):
    ...
    DFEQQN_D1 = Symsubcircuit(cellInfo['name'], ['D', 'E', 'CLK', 'Q', 'QN', 'VDD', 'VSS'])
    # Clock inverters
    ...
    # Slave latch
    invz_ms = invz_par("invz_ms", ['di', 'clki', 'clkn', 'qin', 'VDD', 'VSS'], {'WN' : 620e-9, 'WP' : 900e-9})
    inv_sl = inv_par("inv_sl", ['qin', 'qi', 'VDD', 'VSS'], {'WN' : 250e-9, 'WP' : 450e-9})
    ...
    DFEQQN_D1.addElement([inv_clkn, inv_clki, inv_enb,
                          n0, n1, n2, n3, n4,
                          p0, p1, p2, p3, p4,
                          inv_ml, invz_mfb, 
                          invz_ms, 
    ...
    # Flatten the circuit
    if genFlat:
        DFEQQN_D1_flat = DFEQQN_D1.flat()
    if anonimize:
        DFEQQN_D1_flat.anonimize()
