...
def info():
    ...
    """
    cellInfo = { 'name' : 'DFERQQN_DL',
                 'pinList' : ['D', 'E', 'RN', 'CLK', 'Q', 'QN', 'VDD', 'VSS'],
                 'description' : 'D flip-flop with enable, reset and Q and QN outputs with weak drive strength'
    }
    return cellInfo
...
def generate(genFlat = True, anonimize = True):
    ...
    DFERQQN_DL = Symsubcircuit(cellInfo['name'], ['D', 'E', 'RN', 'CLK', 'Q', 'QN', 'VDD', 'VSS'])
    # Clock inverters
    ...
    DFERQQN_DL.addElement([inv_clkn, inv_clki, inv_enb,
                          ns, n0, n1, n2, n3, n4,
                          ps, p0, p1, p2, p3, p4,
                          inv_ml, invz_mfb, 
                          invz_ms, 
    ...
    # Flatten the circuit
    if genFlat:
        DFERQQN_DL_flat = DFERQQN_DL.flat()
    if anonimize:
        DFERQQN_DL_flat.anonimize()
