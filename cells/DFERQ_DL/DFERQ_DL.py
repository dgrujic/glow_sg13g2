...
def info():
    ...
    """
    cellInfo = { 'name' : 'DFERQ_DL',
                 'pinList' : ['D', 'E', 'RN', 'CLK', 'Q', 'VDD', 'VSS'],
                 'description' : 'D flip-flop with enable, reset and Q output with weak drive strength'
    }
    return cellInfo
...
def generate(genFlat = True, anonimize = True):
    ...
    DFERQ_DL = Symsubcircuit(cellInfo['name'], ['D', 'E', 'RN', 'CLK', 'Q', 'VDD', 'VSS'])
    # Clock inverters
    ...
    DFERQ_DL.addElement([inv_clkn, inv_clki, inv_enb,
                          ns, n0, n1, n2, n3, n4,
                          ps, p0, p1, p2, p3, p4,
                          inv_ml, invz_mfb, 
                          invz_ms, 
    ...
    # Flatten the circuit
    if genFlat:
        DFERQ_DL_flat = DFERQ_DL.flat()
    if anonimize:
        DFERQ_DL_flat.anonimize()
